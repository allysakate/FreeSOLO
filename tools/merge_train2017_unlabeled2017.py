...
save_path = (
    "datasets/coco/annotations/instances_train2017_unlabel2017_densecl_r101.json"
)

ann_dict_train = json.load(open("training_dir/instances_train2017_densecl_r101.json"))
ann_dict_unlabeled = json.load(
    open("training_dir/instances_unlabeled2017_densecl_r101.json")
)
